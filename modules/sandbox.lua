...
-- ==== ПЕСОЧНЫЙ БЛОК: реестр календарей и дашборд =============================
-- Вставляется ЦЕЛИКОМ в конец копии модуля (Модуль:Песочница/Carn/Calendar),
-- ПЕРЕД последней строкой `return p`. Боевой модуль не трогаем.
-- Использует локальные функции модуля, определённые выше по файлу:
-- purif, trim, isdate, gri2jd, jd2jul, а также mwlang, getArgs, tCon и таблицу e.
...
-- Проверено программным обходом (roundtrip по всем дням 1800–2400 гг.,
-- якоря: копт. 1742-01-01 = 11.09.2025 грег., 1740-01-01 = 12.09.2023).
